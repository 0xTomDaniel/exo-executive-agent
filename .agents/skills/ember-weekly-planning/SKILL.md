...
7. **Commit by owner**
   ...
   - Assign joint commitments.
   - Each commitment should have a clear deliverable or decision, not just a work theme.
...
9. **Route separate economic lanes explicitly**
   - If a parallel client, partner, funding, grant, or salary/runway opportunity appears, name the lane and decide whether it belongs in next week's plan.
   - Do not let a parallel economic lane silently displace the weekly Ember customer/revenue experiment.
   - If the parallel lane matters next week, create a separate commitment/task with owner, timing, and success criteria.
...
- Strategic reality check
- Next-week team MIT
- One primary customer/revenue experiment
