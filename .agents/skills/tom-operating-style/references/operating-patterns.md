...
- For weekly reset anchors such as weekly review and Sunday yoga, prefer reduced explicit versions over silent omission when life is chaotic. Continuity matters more than ideal duration.
...
- Tom has treated the Saturday run / stoned-run ritual as a mandatory weekly reset anchor alongside Sunday yoga. On Saturdays, ask about the run by name; when recovering a missed Saturday later, ask whether it happened and capture the answer on the Saturday note. If the full run is not feasible, use the `planning-rhythm-os` graceful-degradation path and record the chosen substitute or resumption plan rather than silently accepting omission.
...
- Meditation remains the gate before optional work.
- Treat meditation as a chaos antidote: when Tom feels too busy for it, that is usually evidence that it is more needed, not less.
- Preferred sequencing is: mind dump if needed -> meditation -> movement -> work blocks.
